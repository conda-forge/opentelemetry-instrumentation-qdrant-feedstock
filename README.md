About opentelemetry-instrumentation-qdrant-feedstock
====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-qdrant-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-qdrant-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-qdrant
# for installing globally
pixi global install opentelemetry-instrumentation-qdrant
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-qdrant` available on your platform:
...
```
pixi search opentelemetry-instrumentation-qdrant --channel conda-forge
```
